export const dict = {
  ...
  "settings.mcp.description": "Manage Model Context Protocol (MCP) servers and how their tools are discovered.",
  "settings.mcp.section.discovery": "Tool discovery",
  "settings.mcp.section.servers": "Configured servers",
  "settings.mcp.empty": "No MCP servers configured. Add one below.",
  "settings.mcp.tag.deferred": "deferred",
  "settings.mcp.row.deferDefault.title": "Defer MCP tools by default",
  "settings.mcp.row.deferDefault.description": "Hide MCP tool schemas from the model and expose a single mcp_search tool instead. Saves context for large MCP servers.",
  "settings.mcp.row.searchMode.title": "Search mode",
  "settings.mcp.row.searchMode.description": "Smart uses local query expansion (default). Standard is strict token match. Augment reranks smart matches with an LLM.",
  "settings.mcp.row.augmentModel.title": "Augment model",
  "settings.mcp.row.augmentModel.description": "Provider/model id used for augment search reranking, e.g. deepseek/deepseek-v4-flash.",
  "settings.mcp.row.timeout.title": "Default timeout (ms)",
  "settings.mcp.row.timeout.description": "Per-request timeout for MCP server calls. Leave blank for the default (30000).",
  "settings.mcp.row.enabled": "Enabled",
  "settings.mcp.row.defer": "Defer",
  "settings.mcp.search.mode.smart": "Smart (default)",
  "settings.mcp.search.mode.standard": "Standard (strict tokens)",
  "settings.mcp.search.mode.augment": "Augment (LLM rerank)",
  "settings.mcp.action.connect": "Connect",
  "settings.mcp.action.disconnect": "Disconnect",
  "settings.mcp.action.delete": "Delete",
  "settings.mcp.action.delete.confirm": "Remove MCP server '{{name}}'?",
  "settings.mcp.add.title": "Add MCP server",
  "settings.mcp.add.button": "Add MCP server",
  "settings.mcp.add.submit": "Add server",
  "settings.mcp.add.success": "MCP server added.",
  "settings.mcp.add.field.name": "Name",
  "settings.mcp.add.field.url": "URL",
  "settings.mcp.add.field.command": "Command (space-separated)",
  "settings.mcp.add.type.remote": "Remote (HTTP/SSE)",
  "settings.mcp.add.type.local": "Local (subprocess)",
  "settings.mcp.add.error.name": "Server name is required.",
  "settings.mcp.add.error.url": "URL is required for remote servers.",
  "settings.mcp.add.error.command": "Command is required for local servers.",
  "settings.mcp.add.error.duplicate": "An MCP server with that name already exists.",
  "settings.mcp.add.error.generic": "Failed to add MCP server.",
  "settings.mcp.help.location": "Settings are saved to your user config:",
  "settings.mcp.help.docs": "MCP servers documentation →",
