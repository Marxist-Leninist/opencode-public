...
const OPENROUTER_ROUTER_MODELS = {
  ...
  "openrouter/auto@preset/latency": {
    id: "openrouter/auto@preset/latency",
    name: "Auto Router + Latency (preset)",
    attachment: true,
    reasoning: true,
    tool_call: true,
    temperature: true,
  ...
  "openrouter/free@preset/latency": {
    id: "openrouter/free@preset/latency",
    name: "Free Models Router + Latency (preset)",
    attachment: true,
    reasoning: true,
    tool_call: true,
    temperature: true,
  ...
  "google/gemini-3.1-pro-preview": {
    ...
    name: "Gemini 3.1 Pro (preview, vision)",
    attachment: true,
    reasoning: true,
    tool_call: true,
    temperature: true,
